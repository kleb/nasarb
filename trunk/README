...
This and other examples come with the fUnit distribution
in the <tt>examples</tt> directory.  There is also an
emacs mode in the <tt>utils</tt> directory.  If you installed the
...
* To avoid Fortran's 32-character limit, don't add test name
  during translation.
...
* To increase portability, create stand-alone executables with
